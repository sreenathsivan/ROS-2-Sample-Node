...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/src/install/lowcost_arm_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lowcost_arm_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lowcost_arm_description/environment/path.sh"
